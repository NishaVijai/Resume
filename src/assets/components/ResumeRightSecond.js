				...
				<article id="second">
					...
					<div className="projects-container">
						...
						<div className="project-5-description project-description">
							<p>
								First ever group project working with two remote team members from England and Uganda.
								We build a static cloned Chingu website using HTML, CSS and JavaScript {' '}
								<a
					...
					<div className="projects-container">
						...
						<div className="project-6-description project-description">
							<p>
								...
								using HTML, CSS and Vanilla JavaScript. Gained my first experience to deploy a website
								using GitHub io. Github repository link -{' '}
								<a
