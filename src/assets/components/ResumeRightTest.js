		...
		return (
			<div id="resume-right-container">
				...
				<div id="second">
					...
					<div id="projects-container">
						...
						<div className="project-5-description project-description">
							<p>
								First ever group project work to build a static cloned Chingu website using HTML, CSS
								and JavaScript<a
								...
								</a>with two remote team members from England and Uganda. We used GitHub io to deploy
								our webpage. Github repository link - {' '}
								<a
					...
					<div id="projects-container">
						...
						<div className="project-6-description project-description">
							<p>
								...
								using HTML, CSS and JavaScript. Gained my first experience to deploy a website by GitHub
								io. Github repository link -{' '}
								<a
				...
				<div id="third">
					...
					<div id="education-container">
						<div className="education-7 degrees">
							<p>1988 - 1993</p>
